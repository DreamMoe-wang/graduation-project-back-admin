...
-- =============================================
-- 测试发布数据
-- 状态：0-草稿，1-待审核，2-审核不通过，3-上架中，4-已下架
-- =============================================
...
VALUES
    (101, 'TP202603310001', 11, 1, '上门空调清洗', '需要清洗两台壁挂式空调，周末优先。', 150.00, '北京', '海淀区', '中关村软件园一期', '爱丽丝', '13800138011', 3, 1, '2026-03-25 09:10:00', '信息完整，审核通过', '2026-03-25 09:15:00', NULL, 0, '2026-03-25 08:30:00', '2026-03-25 09:15:00'),
    ...
    (105, 'TP202603310005', 12, 2, '上门电脑重装系统', '提供 Windows 系统重装和基础软件安装。', 120.00, '北京', '东城区', '东直门附近', '鲍勃', '13800138012', 4, 1, '2026-03-24 14:00:00', '审核通过', '2026-03-24 14:10:00', '2026-03-30 18:20:00', 0, '2026-03-24 13:30:00', '2026-03-30 18:20:00'),
    (106, 'TP202603310006', 15, 1, '家教辅导 - 初中数学', '每周三次，每次两小时，地点可协商。', 300.00, '北京', '西城区', '金融街附近', '艾琳', '13800138015', 3, 1, '2026-03-29 15:30:00', '审核通过', '2026-03-29 15:35:00', NULL, 0, '2026-03-29 15:00:00', '2026-03-29 15:35:00')
ON DUPLICATE KEY UPDATE
    `title` = VALUES(`title`),
